...
### 未编号公式 #67 — 未编号公式：\mathcal{A}(\mathbf{x}^c) ...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 504 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L504)
...
```
### 未编号公式 #68 — 未编号公式：\Delta t^{(j-1)} = t^{(j)}...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 509 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L509)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
...
6140:   }
```
### 未编号公式 #69 — 未编号公式：\mathbf{d}^{(j)} = \mathbf...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 514 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L514)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
...
```
### Eq. (23) — f' 递推
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 519 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L519)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
...
```
### Eq. (24) — f" 递推
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 523 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L523)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
