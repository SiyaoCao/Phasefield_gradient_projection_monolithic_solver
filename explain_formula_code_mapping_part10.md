## 040. ### 3.1. Algorithm overview（explain.md:L321-L323）

- 对应关系说明：本公式位于算法主循环层：投影、搜索方向、线搜索与收敛判据。
- 最底层代码链接：
  - [main.cc:L4196-L4311](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L4196-L4311)
  - [main.cc:L4348-L4367](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L4348-L4367)

### 代码片段 1（main.cc:L4196-L4311）
```cpp
...
## 041. ### 3.1. Algorithm overview（explain.md:L327-L329）
...
## 042. ### 3.1. Algorithm overview（explain.md:L336-L338）
...
## 043. ### 3.1. Algorithm overview（explain.md:L340-L342）
...
## 044. ### 3.1. Algorithm overview（explain.md:L344-L346）
