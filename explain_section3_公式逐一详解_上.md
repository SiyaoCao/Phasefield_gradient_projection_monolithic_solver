...
\] 负责“从独立自由度映射到全自由度”，\[
\mathbf{k}
\] 负责非齐次边值贡献。该结构允许在迭代中稳定施加线性约束而不破坏优化框架。
...
- 详细解读：\[
\mathbf{x}^*
\] 与广义 Cauchy 点共同定义搜索方向，影响线搜索效率和全局收敛表现。
...
- 详细解读：\[
\alpha_k
\] 平衡“下降幅度”和“曲率信息可靠性”，过大可能越界或震荡，过小会导致慢收敛。
...
- 详细解读：这一步非常关键：\[
\mathbf{B}^0_k
\] 既保留有限元稀疏结构，又提供正确尺度，使低秩校正在物理上更可信。
