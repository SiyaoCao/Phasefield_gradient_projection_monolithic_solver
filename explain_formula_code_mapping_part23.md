## 085. #### 3.4.1. Direct matrix factorization for the primal approach（explain.md:L614-L616）
...
## 086. #### 3.4.1. Direct matrix factorization for the primal approach（explain.md:L619-L621）
...
## 087. #### 3.4.1. Direct matrix factorization for the primal approach（explain.md:L623-L625）
