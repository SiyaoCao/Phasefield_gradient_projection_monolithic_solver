...
### 未编号公式 #72 — 未编号公式：\mathbf{B} = \mathbf{B}^0 ...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 528 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L528)
...
6140:   }
```
### 未编号公式 #73 — 未编号公式：\mathbf{w}_b = \mathbf{W}^...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 532 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L532)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
...
6140:   }
```
### 未编号公式 #74 — 未编号公式：f'_j = f'_{j-1} + \Delta t...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 537 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L537)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
...
6140:   }
```
### 未编号公式 #75 — 未编号公式：f''_j = f''_{j-1} + 2r_b \...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 541 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L541)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
...
6140:   }
```
### 未编号公式 #76 — 未编号公式：\mathcal{A}(\mathbf{x}^c) ...
- 论文位置：[3. Gradient projection based monolithic scheme > 3.3. Generalized Cauchy point，`explain.md` 第 546 行附近](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/main/explain.md#L546)
- 公式解读：该式用于描述本章节对应的变分量、离散量或约束/算法步骤，代码中通过下述函数在单元积分、向量更新、约束投影或线搜索阶段执行。
- 公式（按要求渲染）：
\[
