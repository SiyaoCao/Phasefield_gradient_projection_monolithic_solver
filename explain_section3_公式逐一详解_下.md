...
- 推导：无约束轨迹是 \[ x_i(t)=x_i^0-tr_i \]。令其等于上/下界并解 \[ t \]，按 \[ r_i \] 符号分段得到该式；\[
r_i=0
\] 永不触边，故 \[ +\infty \]。
...
- 含义：二次函数驻点闭式解。
- 推导：\[
\hat p'(\Delta t)=f'_{j-1}+f''_{j-1}\Delta t
\]，令其为零得到。
