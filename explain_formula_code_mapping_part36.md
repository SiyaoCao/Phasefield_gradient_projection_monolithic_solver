## 104. #### 3.4.3. Schur complement for the dual approach（explain.md:L725-L727）
...
## 105. #### 3.4.3. Schur complement for the dual approach（explain.md:L732-L734）
...
## 106. ### 4.1. Cyclic tension-compression test（explain.md:L780-L782）

- 对应关系说明：本公式位于后处理能量统计层：裂纹耗散能积分。
- 最底层代码链接：
...
## 107. ### 4.4. Three-dimensional torsion test（explain.md:L878-L880）

- 对应关系说明：本公式位于边界加载层：扭转位移分量施加。
- 最底层代码链接：
  - [main.cc:L3597-L3607](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L3597-L3607)
  - [main.cc:L3614-L3618](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L3614-L3618)

### 代码片段 1（main.cc:L3597-L3607）
```cpp
...
## 108. ### 5.2. Comparison of convergence behaviors（explain.md:L937-L939）

- 对应关系说明：本公式位于收敛监控层：残差与增量双重阈值判断。
- 最底层代码链接：
  - [main.cc:L5033-L5036](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L5033-L5036)
  - [main.cc:L4564-L4567](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L4564-L4567)
  - [main.cc:L1459-L1513](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L1459-L1513)

### 代码片段 1（main.cc:L5033-L5036）
```cpp
...
## 109. ## Appendix（explain.md:L973-L975）

- 对应关系说明：附录公式对应数值线代中的低秩/逆更新思想，代码中通过小规模矩阵显式求逆实现。
- 最底层代码链接：
  - [main.cc:L5181-L5182](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L5181-L5182)
  - [main.cc:L5591-L5595](https://github.com/SiyaoCao/Phasefield_gradient_projection_monolithic_solver/blob/copilot/create-explain-md-document/main.cc#L5591-L5595)

### 代码片段 1（main.cc:L5181-L5182）
```cpp
5181: 	if (!M_matrix_inv.empty())
5182: 	  M_matrix.invert(M_matrix_inv);
```

### 代码片段 2（main.cc:L5591-L5595）
```cpp
5591: 		FullMatrix<double> middle_matrix_inv(2 * list_size);
5592: 		middle_matrix_inv.invert(middle_matrix);
5593: 
...
## 110. ## Appendix（explain.md:L979-L981）
